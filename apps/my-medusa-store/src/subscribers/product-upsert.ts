...
export default async function productUpsertHandler({
  ...
  try {
    ...
    // ✅ FIX: Medusa's graph query returns links as arrays or single objects depending on relationship card.
    // This safely unwraps the object values so your defaults never throw a crash error.
